...
public class GameOptionPanel extends JPanel
{
	...
	public GameOptionPanel()
	{
		...
		button_griddingColor.setFont(new Font("宋体", 0, 12));
		...
		checkBox_colorfulShape.setFont(new Font("宋体", 0, 12));
		...
		button_obstacleColor.setFont(new Font("宋体", 0, 12));
		...
		checkBox_colorfulObstacle.setFont(new Font("宋体", 0, 12));
		...
		textField_obstacleNum.setFont(new Font("宋体", 0, 12));
		...
		textField_lineNum.setFont(new Font("宋体", 0, 12));
		...
		add(separator_4);
		textField_stayTime.setFont(new Font("宋体", 0, 12));
		...
		button_fullLineColor.setFont(new Font("宋体", 0, 12));
		...
		buttonBackgroundColor.setFont(new Font("宋体", 0, 12));
		buttonBackgroundColor.setFocusable(false);
		buttonBackgroundColor.setText("设置背景颜色");
		button_default.setFont(new Font("宋体", 0, 12));
